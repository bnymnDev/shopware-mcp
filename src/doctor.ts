...
const REQUIREMENTS: Record<string, Requirement> = {
  ...
  order_history: { reads: ["order", "state_machine_history"] },
  ...
  reviews_search: { reads: ["product_review"] },
  ...
  customer_report: { reads: ["customer", "order"] },
  shop_audit: {
    reads: ["order", "product", "promotion", "sales_channel", "plugin", "product_review"],
